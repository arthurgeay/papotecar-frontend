<template>
  ...
  <div class="create-trip flex h-screen w-screen items-center justify-center">
    <div
      class="block rounded-lg border border-gray-200 bg-white p-6 shadow hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 lg:w-2/6"
    >
