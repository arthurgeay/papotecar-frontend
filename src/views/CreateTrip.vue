...
<div class="create-trip flex justify-center items-center w-screen h-screen">
    <div class="block lg:w-1/2 p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
        <h2 class="text-white font-bold text-2xl">Creer un trajet</h2>
        <form>
            ...
            <div class="mb-6">
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Date de départ</label>
                <div class="relative">
