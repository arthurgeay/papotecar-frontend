...
export default {
    ...
    methods: {
        getTrips() {
            ...
            fetch(`https://${import.meta.env.VITE_URL}/trips?departure_location=${this.start}&arrival_location=${this.end}&departure_datetime=${startingDate}&max_passengers=${this.passengers}`, {
                method: 'GET',
                headers: {
